                ...
                for (int i = 22; i <= 22; i++) // initial i =2
                {
                    ...
                    while (j <= arrray[i - 2])
                    {
                        ...
                        using (var csv = new CsvReader(reader, CultureInfo.InvariantCulture))
                        {
                            ...
                            ElementTakeScreenShot(driver.FindElement(By.XPath("//*[@id='mainform']/div[9]/div[4]/div[2]/table/tbody/tr[5]")), "d:\\第 " + n + " 個縣市第 " + j + " 個分行欄位snapshot_" + timepath + ".png");
                            System.Threading.Thread.Sleep(100);
                            ...
                            SCrollToElement(driver, TelephoneColumn);
