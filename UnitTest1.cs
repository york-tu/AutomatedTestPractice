            ...
            using var driver = WebDriverInfra.Create_Browser(browserType);
            {
                ...
                for (int i = 22; i <= 22; i++) // initial i =2
                {
                    ...
                    while (j <= arrray[i - 2])
                    {
                        ...
                        FullNameColumn.SendKeys("許功蓋"); //填姓名
                        //System.Threading.Thread.Sleep(100);

                        IdentityCardColumn.Clear();
                        IdentityCardColumn.SendKeys("A123456789"); //填身分證
                        //System.Threading.Thread.Sleep(100);

                        TelephoneColumn.Clear();
                        TelephoneColumn.SendKeys("0987654321"); //填連絡電話
                        //System.Threading.Thread.Sleep(100);

                        EMailColumn.Clear();
                        EMailColumn.SendKeys("axn0122@yahoo.com.tw"); //填 E-MAIL
                        //System.Threading.Thread.Sleep(100);
                        ...
                        TakeScreenShot("d:\\第 " + n + " 個縣市第 " + j + " 個分行 snapshot_" + browserType + ".png", driver); // snapshot當下畫面
