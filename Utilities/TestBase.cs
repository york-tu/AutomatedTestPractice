...
namespace AutomatedTest.Utilities
{
    public class TestBase
    {
        ...
        #region 圖片辨識
        private static Image Getimage(string sourcepath) //讀取驗證碼圖片
        {
            Bitmap img = new Bitmap(sourcepath);
            return img;
        }
        public static string executing() // 執行圖片處理
        {
            Image lookimg;
        ...
        public static string TesseractOCRIdentify(string filepath, double imagescale) // 執行圖片辨識方法
        {
