...
namespace AutomatedTest.IntegrationTest.Personal.Loan.BailoutLoan
{
    public class 企業紓困貸款預約服務_欄位檢核:IntegrationTestBase
    {
        ...
        public void 送出資料(string browser)
        {
            ...
            IWebElement ExistLoanReliefButton = driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[1]/a")); 
            ...
            string expect_upper_first_line_wordings = "※因防疫期間分行實施人流控管，建議可至 企業紓困專區詳閱準備資料資訊，再進行線上預約服務，以加速申辦流程。";
            ...
            {
                PASS($"上方文案區文案1: 符合預期 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/span[1]")))}");
            }
            else
            {
                FAIL($"上方文案區文案1敘述: {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/span[1]")))}, 預期敘述: {expect_upper_first_line_wordings}");
            }
            if (upper_wordings_second_line == expect_upper_second_line_wordings)
            {
                PASS($"上方文案區文案2: 符合預期 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/span[2]")))}");
            }
            else
            {
                FAIL($"上方文案區文案2敘述: {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/span[2]")))}, 預期敘述: {expect_upper_second_line_wordings}");
            }
            ...
            foreach (var companyName in CompanyNameArray)
            {
                ...
                if (string.IsNullOrWhiteSpace(companyName) == true)
                {
                    ...
                    {
                        PASS($"PASS, 輸入: {companyName} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[1]")))}");
                    }
                    else
                    {
                        FAIL($"FAIL, 輸入: {companyName} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[1]")))}, 預期錯誤訊息: 必須填寫");
                    }
                }
                else if (string.IsNullOrWhiteSpace(companyName) != true && companyName.Length < 2)
                {
                    ...
                    {
                        FAIL($"FAIL, 輸入: {companyName} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[1]")))}, 預期錯誤訊息: 最少2個字");
                    }
                }
                else if (companyName.Length >= 50)
                {
                    ...
                    {
                        WARNING($"NeedCheck, 輸入: {companyName}{ TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[1]")))}");
                    }
                    else
                    {
                        FAIL($"FAIL, 輸入: {companyName} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[1]")))}, 預期: 長度限制50字元");
                    }
                }
                else
                {
            ...
            foreach (var Principal in PrincipalArray)
            {
                ...
                if(string.IsNullOrWhiteSpace(Principal) == true)
                {
                    ...
                    {
                        PASS($"輸入: {Principal}  {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[3]")))}");
                    }
                    else
                    {
                        FAIL($"輸入: {Principal}  {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[3]")))}, 預期錯誤訊息: 必須填寫");
                    }
                }
                else
                {
                    WARNING($"NeedCheck, 輸入:{Principal}  {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[3]")))}");
                }
            }
            ...
            foreach (var contactPerson in ContactPersonArray)
            {
                ...
                if(string.IsNullOrWhiteSpace(contactPerson) == true)
                {
                    ...
                    {
                        PASS($"輸入: {contactPerson}  {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[4]")))}");
                    }
                    else
                    {
                        FAIL($"輸入: {contactPerson}  {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[4]")))}, 預期錯誤訊息: 必須填寫");
                    }
                }
                else
                {
                    WARNING($"NeedCheck, 輸入:{contactPerson}  {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[4]")))}");
                }
            }
            ...
            foreach (var areaCode in telephoneAreaCodeArray)
            {
                ...
                if (string.IsNullOrWhiteSpace(areaCode) == true ) // 當輸入為空值
                {
                    ...
                    {
                        PASS($"輸入: {areaCode} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}");
                    }
                    else
                    {
                        FAIL($"輸入: {areaCode} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}, 預期錯誤訊息: 必須填寫");
                    }
                }
                else if (string.IsNullOrWhiteSpace(areaCode) != true && telephoneAreaCodeCheck != true) // 當輸入不是空值 & 輸入不為"全數字"
                {
                    ...
                    {
                        FAIL($"輸入: {areaCode} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))} 預期錯誤訊息: 僅能輸入數字");
                    }
                }
                else if (telephoneAreaCodeCheck ==true) // 當輸入為全數字
                {
                    ...
                    {
                        FAIL($"輸入: {areaCode} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}, 預期錯誤訊息: n/a, 預期長度: 4位數以內");
                    }
                }
                else // 以上Case皆不是時, 需人工check
                {
                       WARNING($"NeedCheck, 輸入: {areaCode} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}");
                }
            }
            ///<summary>
            ///連絡電話-主碼-欄位檢核
            ...
            foreach (var telephoneMain in telephoneMainArray )
            {
                ...
                if (string.IsNullOrWhiteSpace(telephoneMain) == true ) // 當輸入為空值
                {
                    ...
                    {
                        PASS($"輸入: {telephoneMain} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}");
                    }
                    else
                    {
                        FAIL($"輸入: {telephoneMain} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}, 預期錯誤訊息: 必須填寫");
                    }
                }
                else if (string.IsNullOrWhiteSpace(telephoneMain) != true && telephoneMainCheck != true) // 當輸入不為空值但輸入"不全為數字"
                {
                    ...
                    {
                        FAIL($"輸入: {telephoneMain} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}, 預期錯誤訊息: 僅能輸入數字");
                    }
                }
                else if (telephoneMainCheck ==true) // 當輸入為全數字
                {
                    ...
                    {
                        FAIL($"輸入: {telephoneMain} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}, 預期錯誤訊息: n/a, 預期長度: 8 位數以內");
                    }
                }
                else // 以上Case皆不是時, 需人工check
                {
                       WARNING($"NeedCheck, 輸入: {telephoneMain} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}");
                }
            }
            ///<summary>
            ///連絡電話-分機-欄位檢核
            ...
            foreach (var telephoneExtension in telephoneExtensionArray )
            {
                ...
                if (string.IsNullOrWhiteSpace(telephoneExtension) == true ) // 當輸入為空值
                {
                    ...
                    {
                        PASS($"輸入: {telephoneExtension} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}");
                    }
                    else
                    {
                        FAIL($"輸入: {telephoneExtension}, {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}, 預期錯誤訊息: n/a (非必填)");
                    }
                }
                else if (string.IsNullOrWhiteSpace(telephoneExtension) != true && telephoneExtensionCheck  != true) // 當輸入不為空值但輸入"不全為數字"
                {
                    ...
                    {
                        FAIL($"輸入: {telephoneExtension} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}, 預期錯誤訊息: 僅能輸入數字");
                    }
                }
                else if ( telephoneExtensionCheck == true  && telephoneExtension.Length < 6 )  // 當輸入為全數字 且 數字長度 < 6位
                {
                    ...
                    {
                        FAIL($"輸入: {telephoneExtension} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[5]")))}, 預期錯誤訊息: n/a, 預期長度: 6 位數以內");
                    }
                }
                else if (telephoneExtensionCheck ==true  &&  telephoneExtension.Length >= 6) // 當輸入為全數字 且 數字長度 >= 6位
                {
            ...
            foreach (var input in phones)
            {
                ...
                bool cellPhoneNumberCheck = Regex.IsMatch(actualColumnCellphone, @"^09\d{8}$"); // 判斷輸入是否為行動電話09開頭格式 (正則表示式: 09開頭後面8碼數字) 

                 if (string.IsNullOrWhiteSpace(input) == true ) // 當輸入為空值
                {
                    if(cellphone_error== "必須填寫")
                    {
                        PASS($"輸入: {input} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[6]")))}");
                    }
                    else
                    {
                        FAIL($"輸入: {input} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[6]")))}, 預期錯誤訊息: 必須填寫");
                    }
                }
                else if (numericCheck != true) // 當輸入"不全為數字"
                {
                    ...
                    {
                        FAIL($"輸入: {input} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[6]")))}, 預期錯誤訊息: 行動電話格式錯誤");
                    }
                }
                ...
                {
                       WARNING($"NeedCheck, 輸入: {input} {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[6]")))}, 預期錯誤訊息: n/a, 預期長度: 09開頭的10位數字");
                }
            }
           ...
           string appointment_visit_time_information = appointment_visit_time_column.Substring(appointment_visit_time_column.IndexOf("※"));
            if (appointment_visit_time_information == "※為提升服務品質並進行顧客蒞行服務分流，本服務僅供每人每次預約１個時段，造成不便，請您見諒。")
            {
                PASS($"PASS {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[9]")))}"); 
            }
            else
            {
                FAIL($"FAIL {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[9]")))}, 預期錯誤訊息: ※為提升服務品質並進行顧客蒞行服務分流，本服務僅供每人每次預約1個時段，造成不便，請您見諒。");
            }
        ...
        rerun_ihaveread:
            ...
            { 
                ...
                {
                    PASS($"PASS, 未勾選選項 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[11]/td[2]/div")))}");
                }
                else
                {
                    FAIL($"FAIL, 未勾選選項 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[11]/td[2]/div")))} 預期錯誤訊息: 必須填寫");
                }
            ...
            else
            {
                ...
                {
                    PASS($"PASS, 已勾選選項 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[11]/td[2]/div")))}");
                }
                else
                {
                    FAIL($"FAIL, 已勾選選項 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[11]/td[2]/div")))}, 預期錯誤訊息: n/a");
                }
            }
        ...
        rerun_CaptchaSteps:
            ...
            if (string.IsNullOrWhiteSpace(image_verification_column_value) == true)
            {
                ...
                {
                     PASS($"PASS, 未輸入驗證碼 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[10]")))}");
                }
                else
                {
                    FAIL($"FAIL, 未輸入驗證碼 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[10]")))}, 預期錯誤訊息: 請輸入驗證碼");
                }    
            ...
            else
            {
                ...
                {
                     PASS($"PASS, 輸入錯誤驗證碼 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[10]")))}");
                }
                else
                {
                    FAIL($"FAIL, 輸入錯誤驗證碼 {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/div[2]/table/tbody/tr[10]")))}, 預期錯誤訊息: 驗證碼錯誤");
                }  
            }
            ...
            {
                PASS($"PASS {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/span[3]")))}");
            }
            else
            {
                FAIL($"FAIL {TestBase.ElementSnapShotToReport(driver.FindElement(By.XPath("//*[@id='mainform']/div[7]/div[3]/div[2]/div[1]/span[3]")))}, 預期敘述: ※提醒您，點擊「確認」送出預約後，請依預約前往分行臨櫃申請，若您未於預約時間來行，為配合政府防疫措施，請勿直接至分行申請。");
            }
