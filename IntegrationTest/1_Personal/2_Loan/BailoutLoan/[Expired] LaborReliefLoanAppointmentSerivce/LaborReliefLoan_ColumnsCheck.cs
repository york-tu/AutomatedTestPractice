...
{
    public class 勞工紓困貸款預約服務_欄位檢核:IntegrationTestBase
    {
        public 勞工紓困貸款預約服務_欄位檢核(ITestOutputHelper output, Setup testSetup) : base(output, testSetup)
        {
        ...
        {
            StartTestCase(browser, "勞工紓困貸款預約服務_欄位檢核", "York");
            INFO("確認欄位檢核正確");
